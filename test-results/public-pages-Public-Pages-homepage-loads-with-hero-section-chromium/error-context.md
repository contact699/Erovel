...
- Name: public-pages.spec.ts >> Public Pages >> homepage loads with hero section
- Location: e2e\public-pages.spec.ts:9:7
...
Locator: getByText('Stories that ignite')
Expected: visible
Error: strict mode violation: getByText('Stories that ignite') resolved to 2 elements:
    1) <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight">…</h1> aka getByRole('heading', { name: 'Stories that ignite.' })
    2) <p class="text-xs text-muted leading-relaxed">A platform for adult fiction creators and readers…</p> aka getByText('A platform for adult fiction creators and readers. Stories that ignite.')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Stories that ignite')
      ...
      - generic [ref=e50]:
        ...
        - generic [ref=e82]:
          ...
          - generic [ref=e91]:
            ...
            - link "Illustrated The Hotwife Games A story about a couple invited to participate in an elite hotwife game run by the swing club they belong to. C Chatkink 4 0 0 6 chapters · 0 min read 3m ago" [ref=e119] [cursor=pointer]:
              ...
              - generic [ref=e120]:
                ...
                - generic [ref=e124]:
                  ...
                  - generic [ref=e143]:
                    ...
                    - generic [ref=e145]: 3m ago
            - link "Sext One Man, Two Birds — Ch. 01 Imported from imgchest (39 images) P patrob1 2 0 0 1 chapters · 0 min read 3m ago" [ref=e146] [cursor=pointer]:
